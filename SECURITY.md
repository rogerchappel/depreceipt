...
Replace this section with the supported versions for `depreceipt`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `depreceipt` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in depreceipt.
